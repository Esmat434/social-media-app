...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'notification.context_processros.notification_count',
            ],
        },
    },
]
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(minutes=15),  # توکن اصلی
    'REFRESH_TOKEN_LIFETIME': timedelta(days=60),     # توکن تمدید
...
EMAIL_HOST_PASSWORD = 'cbay bqjp lnco zzac'